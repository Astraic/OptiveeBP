...
require_once(dirname(__FILE__, 4) . '/app/framework/database/QueryBuilder.php');
...
final class QueryBuilderTest extends TestCase
{
    ...
    public function setUp() : void{
        ...
        $this->queryBuilder = new \app\framework\database\QueryBuilder($this->mock);
    }

    public function testGenerateSql(): void
    {
        $output = "SELECT id FROM Animal WHERE id = :id ORDER BY id DESC";
    ...
    {
        $output = "SELECT * FROM Animal WHERE id = :id ORDER BY id DESC";
    ...
    {
        $output = "SELECT id, name FROM Animal WHERE name = :name AND id > :id ORDER BY id DESC, name ASC";
