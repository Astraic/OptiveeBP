...
class QualityTest extends TestCase {
    ...
    function setUp() : void {
        ...
        $this->mockUpdate->expects($this->any())->method('getSql')->will($this
            ->returnValue('UPDATE Quality SET catname = :catnameUpdate, fatname = :fatnameUpdate, meatname = :meatnameUpdate WHERE animalid = :animalid'));
        ...
        $this->input2 = new \app\entity\model\Quality();
