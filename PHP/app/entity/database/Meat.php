...
/**
 * Databinding voor create, update en read queries voor Meat model class.
 * @author Stephan de Jongh
 */

class Meat extends \app\framework\database\CRUD implements \app\framework\database\Read, \app\framework\database\Write, \app\framework\database\Update {
    ...
    function __construct(\app\framework\database\QueryBuilderParent ...$query){
        $sql = "INSERT INTO Meat (name) VALUES (:name)";
    ...
    function select(\app\framework\model\Model $model) : array{
        ...
        $results = $this->select[0]->fetchAll(\PDO::FETCH_CLASS|\PDO::FETCH_PROPS_LATE, '\app\entity\model\Meat');
