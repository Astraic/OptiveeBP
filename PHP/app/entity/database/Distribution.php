...
class Distribution extends \framework\database\CRUD implements \framework\database\Read, \framework\database\Write, \framework\database\Update {
    ...
    function select(\model\Model $model) : array{
        ...
        $results = $this->select[0]->fetchAll(\PDO::FETCH_CLASS|\PDO::FETCH_PROPS_LATE, 'model\Distribution');
