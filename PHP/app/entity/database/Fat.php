...
class Fat extends \app\framework\database\CRUD implements \app\framework\database\Read, \app\framework\database\Write, \app\framework\database\Update {
    ...
    function select(\app\framework\model\Model $model) : array{
        ...
        $results = $this->select[0]->fetchAll(\PDO::FETCH_CLASS|\PDO::FETCH_PROPS_LATE, '\app\entity\model\Fat');
