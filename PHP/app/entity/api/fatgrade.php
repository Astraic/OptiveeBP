...
require_once(dirname(__FILE__,3) . '/entity/database/FatGrade.php');

/**
 * API ter behoeve van framework voor fatgrade model class.
 * @author Stephan de Jongh
 */

class FatGrade extends \app\framework\api\ForcedApi {
...
$api = new \app\entity\api\FatGrade();
?>